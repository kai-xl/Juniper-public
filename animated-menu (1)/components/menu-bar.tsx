...
const menuItems: MenuItem[] = [
  {
    icon: (
      ...
      >
        <Image src="/images/juniper-logo.png" alt="Home" width={20} height={20} className="object-contain" />
      </motion.div>
    ),
    label: "Home",
    href: "#",
  ...
  const updatedMenuItems: MenuItem[] = [
    {
      icon: (
        <motion.div
          className="relative p-2 -m-2" // Bigger hitbox
          animate={
            isHomeHovered
              ? {
                  y: [-1, -3, -2, -3, -1],
        ...
        >
          <Image
            src={isHomeHovered ? "/images/junipermouth.png" : "/images/juniper.png"}
            alt="Home"
            width={80}
            height={80}
